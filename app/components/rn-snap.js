...
export class RNSNap extends React.Component {
    ...
    render() {
        ...
        return (
          <ScrollViewComponent {...props}>
            {this.props.data && this._getCustomData().map((item, index) => {
               return this._renderItem({ item, index });
             })}
             {this.props.children &&
                 this._renderChildren({ children: this.props.children })}
          </ScrollViewComponent>
        )
    }
}
